...
from bot.keyboards.inline.bot_management import get_parse_mode_keyboard, get_list_bot_user_keyboard, get_subbot_owner_keyboard
    ...
    if bot.token == main_bot.token:
        ...
        if tg_user.id == sub_bot.owner.telegram_id:
            ...
            if sub_bot.bot_type == "LST":
                reply_markup = get_list_bot_user_keyboard(i18n, support_link=sub_bot.support_link)
            else:
